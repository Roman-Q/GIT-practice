...
и используем команду "git pull origin master --allow-unrelated-histories" для соединения историй 2 несвязанных до этого репозиториев(папок). По сути главное решение всех проблем.
